...
echo -e "\033[0;00m"
echo -e "\e[36m"
./tg -s ./LORD.lua -p PROFILE --bot=$token
done
]])  
file:close()  
file = io.open("SLP", "w")  
...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/SRC-LoRdShiP/Files_Lord/main/File_Bot/commands.lua") 
...
local UserName = (data.username_ or "BB33L")
...
sendAudio(msg.chat_id_,msg.id_,'./'..ffrr,"سورس ألسيـآدة")  
...
os.execute('rm -rf LORD.lua')
os.execute('wget wget https://raw.githubusercontent.com/SRC-LoRdShiP/LORD/main/LORD.lua')
send(msg.chat_id_, msg.id_,'♔┇  تم تحديث السورس\n♔┇  لديك اخر اصدار لسورس ألسيـآدة\n♔┇  الاصدار » { v 1}')
dofile('LORD.lua')  
end
if text == 'الاصدار ♔' and DevSoFi(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' ♔┇  اصدار سورس ألسيـآدة \n ♔┇  الاصدار »{ v 1}')
end
...
-------------
if text == "♔ تحديثات سورس ألسيـآدة ♔" and DevSoFi(msg) then  
local updatech =[[
*يجب عليك الاشتراك في قناة*
*تحديثات وشروحات سورس ألسيـآدة*
*قم بالضغط في الاسفل ليحولك الئ القناة*
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '➺💻┇𝚂𝙾𝙺𝚁𝙲𝙴 𝙻𝙾𝚁𝙳𝚂𝙷𝙸𝙿 ➤', url="t.me/BB33O"}},
}
...
usertext = '\n ♔┇  العضو » ['..result.title_..'](t.me/'..(username or 'BB33L')..')'
status  = '\n ♔┇  تم ترقيته مطور'
...
usertext = '\n ♔┇  العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'BB33L')..')'
status  = '\n ♔┇  تم ترقيته مطور'
...
if s00f41_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ♔┇  العضو » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'BB33L')..') \n ♔┇  '..s00f41_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
...
send(msg.chat_id_,0," ♔┇  العضو : {["..data.first_name_.."](T.ME/BB33L)}\n ♔┇  ["..s00f4_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, " ♔┇  عذرا » {["..data.first_name_.."](T.ME/BB33L)}\n ♔┇  عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
os.execute('rm -rf LORD.lua')
os.execute('wget https://raw.githubusercontent.com/SRC-LoRdShiP/LORD/main/LORD.lua')
send(msg.chat_id_, msg.id_,'♔┇  تم تحديث السورس\n♔┇  لديك اخر اصدار لسورس ألسيـآدة\n♔┇  الاصدار » { v 1}')
dofile('LORD.lua')  
end
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,' ♔┇  بواسطه » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'BB33L')..') \n ♔┇  تـم قفـل الدردشه ')
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ♔┇  بواسطه » ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'BB33L')..') \n ♔┇  تـم قفـل التاك بالكتم ')
end,nil)   
...
if DevSoFi(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/SRC-LoRdShiP/Files_Lord/main/getfile.json")
if res == 200 then
local Get_info, res = pcall(JSON.decode,Get_Files);
vardump(res.plugins_)
if Get_info then
local TextS = "\n ♔┇  اهلا بك في متجر ملفات ألسيـآدة\n ♔┇  ملفات السورس ↓\n❉⊶────❪𝙇𝙋𝙨❫────⊷❉\n\n"
local TextE = "\n❉⊶────❪𝙇𝙋𝙨❫────⊷❉\n ♔┇  علامة تعني { ✔️ } ملف مفعل\n ♔┇  علامة تعني { ✖ } ملف معطل\n ♔┇  قناة سورس ألسيـآدة ↓\n".." ♔┇  [اضغط هنا لدخول](t.me/BB33L) \n"
local NumFile = 0
...
local json_file, res = https.request("https://raw.githubusercontent.com/SRC-LoRdShiP/Files_Lord/main/File_Bot/"..file)
if res == 200 then
os.execute("rm -fr File_Bot/"..file)
send(msg.chat_id_, msg.id_,t) 
dofile('LORD.lua')  
else
send(msg.chat_id_, msg.id_," ♔┇  عذرا الملف لايدعم سورس ألسيـآدة \n") 
end
return false
end
...
local UserName = (b.username_ or "SRC-LoRdShiP")
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n ♔┇  لعضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'BB33L')..')'
status  = '\n ♔┇  تم تنزيله من المميزين'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n ♔┇  العضو » '..userid..''
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ♔┇  العضــو » ['..data.first_name_..'](t.me/'..(data.username_ or 'BB33L')..')'
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n ♔┇  العضو » ['..result.title_..'](t.me/'..(text1[3] or 'BB33L')..')'..'\n ♔┇  تم رفعه '..text1[2]..'')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
if text == ""..(database:get(bot_id..'Name:Bot') or 'ألسيـآدة').."" then  
Namebot = (database:get(bot_id..'Name:Bot') or 'ألسيـآدة')
local s00f4_Msg = {
'عمغي 🥺💕.',
...
-------------------------------
if text == ""..(database:get(bot_id..'Name:Bot') or 'ألسيـآدة').." غادر" or text == 'بوت غادر' then  
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(extra,data) 
local rtp = Rutba(result.sender_user_id_,msg.chat_id_)
local username = ' ['..data.first_name_..'](t.me/'..(data.username_ or 'BB33L')..')'
local iduser = result.sender_user_id_
...
send(msg.chat_id_, msg.id_, t..'❉⊶────❪𝙇𝙋𝙨❫────⊷❉\n♔┇  ➺ .[💻┇𝚂𝙾𝙺𝚁𝙲𝙴 𝙻𝙾𝚁𝙳𝚂𝙷𝙸𝙿 ➤ ](t.me/BB33L)✫ ')
end
...
local Name_Bot = (database:get(bot_id..'Name:Bot') or 'ألسيـآدة')
