...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/SRC-BRO/Files_BRO/main/File_Bot/commands.lua") 
...
local json_file, res = https.request("https://raw.githubusercontent.com/SRC-BRO/Files_BRO/main/File_Bot/"..file)
if res == 200 then
